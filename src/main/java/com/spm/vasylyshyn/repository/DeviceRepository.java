...
//    @Query("select new com.spm.vasylyshyn.dto.DeviceDto(d.numberOfDevice,d.cantoraName,d.displayCounts,d.address,d.frequency,d.counterType,d.price,d.createdDate) from Device as d")
